...
from .views import album_view, image_view, add_photo, AddAlbum, EditImage, EditAlbum
...
urlpatterns = [
    ...
    url(r'^photos/(?P<pk>[0-9]+)/edit', EditImage.as_view(), name='edit_image'),
    url(r'^albums/(?P<pk>[0-9]+)/edit', EditAlbum.as_view(), name='edit_album'),
